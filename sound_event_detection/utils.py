...
def augmentation_transforms(trans_list):
    transforms = []
    for trans in trans_list:
        if trans == 'time_shift':
            transforms.append(augmentation.time_shift(0, 50))
        elif trans == 'freq_shift':
            transforms.append(augmentation.freq_shift(0, 4))
        elif trans == 'add_noise':
            transforms.append(augmentation.add_noise())
        elif trans == 'time_mask':
            transforms.append(augmentation.time_mask())
        elif trans == 'freq_mask':
            transforms.append(augmentation.freq_mask())
